...
--
-- Host: localhost:3306
-- Generation Time: Dec 10, 2019 at 05:21 PM
...
(4, 'delta', 'delta@gmail.com', 'YHDZX8c=', 'meh', '2019-12-10 16:01:30', '');
...
(2, 'asd', 'sadsa', '2019-11-12', '10:00:00', 5, NULL, '2019-11-28 08:32:13', NULL, 'Ini notes'),
...
(1, 1, 1, 'meh', '2019-12-11 00:17:29', ''),
(1, 2, 2, 'meh', '2019-12-11 00:19:04', '');
...
(1, 'james', 'jaameess', '08213213', 'fasf@gmail.com', NULL, '2019-12-10 15:40:50', NULL);
...
--
ALTER TABLE `kursi`
  MODIFY `ID_K` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
